...
namespace MacroSln
{
    ...
    public class VisualStudioProject
    {
        ...
        /// </remarks>
        ///
        public static VisualStudioProject Create(string path)
        {
        ...
        ///
        /// <remarks>
        /// If a file already exists at <paramref name="path"/>, it is completely replaced with no consideration given
        /// to its existing encoding, line-ending, or BOM conventions.
        ///
        /// This method can throw IO-related exceptions, see
        /// <see cref="File.WriteAllLines(string, IEnumerable{string}, Encoding)"/> and
        /// <see cref="File.ReadLines(string)"/> for details.
        /// </remarks>
        ///
        public static VisualStudioProject Create(string path, VisualStudioProjectSdk sdk)
        {
        ...
        public IReadOnlyList<VisualStudioProjectGroup> Groups
        {
            get { return _groups; }
        }

        List<VisualStudioProjectGroup> _groups;
        ...
        int ProjectBeginLineNumber;


        int ProjectEndLineNumber;
        ...
        ///
        /// <remarks>
        /// If the property is already present, its value is changed.  Otherwise, the property is added, along with a
        /// containing PropertyGroup if necessary.
        /// </remarks>
        ///

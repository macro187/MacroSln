...
namespace MacroSln
{
    ...
    public class VisualStudioSolutionProjectReference
    {
        ...
        /// </remarks>
        ///
        public string MSBuildTargetName =>
            string.Join(
                "\\",
                GetNestingPath()
                    .Reverse()
        ...
        IEnumerable<VisualStudioSolutionProjectReference> GetNestingPath()
        {
            for (var p = this; p != null; p = p.GetNestingParent()) yield return p;
        }


        VisualStudioSolutionProjectReference GetNestingParent() =>
        ...
        string EscapeMSBuildTargetNameComponent(string component) =>
            component
                .Replace('%', '_')
                .Replace('$', '_')
                .Replace('@', '_')

...
/// </exception>
///
public static VisualStudioSolution
Find(string directoryPath)
{
...
///
public
VisualStudioSolution(string path)
{
...
public int
SolutionConfigurationsStartLineNumber
{
    get; private set;
}
...
public int
SolutionConfigurationsEndLineNumber
{
    get; private set;
}
...
public int
ProjectConfigurationsStartLineNumber
{
    get; private set;
}
...
public int
ProjectConfigurationsEndLineNumber
{
    get; private set;
}
...
///
public void
AddNestedProject(string childProjectId, string parentProjectId)
{
